<nav id="header" class="navbar navbar-light fixed-top shadow-sm" style="padding-bottom:0; background-color:#fff">
    ...
    @auth
        ...
        <ul class="nav nav-pills text-center w-100 mt-1">
            ...
            <li class="nav-item" style="width:33%;">
                <a class="nav-link" style="color:#ffcb42; display:inline-block; width:90%; white-space: nowrap; font-size:clamp(10px,3vw,14px);" href="{{ route('quests.create') }}">
                    <i class="fas fa-gem fa-2x" style="color:#ffcb42;"></i>
                    <br>
                    <b>クエスト</b>
                </a>
            </li>
            <li class="nav-item" style="width:33%;">
                <a class="nav-link" style="color:#999999; display:inline-block; width:90%; white-space: nowrap; font-size:clamp(10px,3vw,14px);" href="{{ route('rankings.index') }}">
                    <i class="fas fa-crown fa-2x" style="color:#999999;"></i>
                    <br>
                    <b>ランキング</b>
                </a>
            </li>
