    ...
    @auth
        ...
        <ul class="nav nav-pills text-center w-100 mt-1">
            <li class="nav-item" style="width:33%;">
                <a class="nav-link" style="color:#ffcb42; display:inline-block; width:90%; white-space: nowrap; font-size:clamp(10px,3vw,14px);" href="{{ route('mains.index') }}">
                    <i class="fas fa-home fa-2x" style="color:#ffcb42;"></i>
                    <br>
                    <b>ホーム</b>
                </a>
            </li>
