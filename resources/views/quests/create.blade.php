                    ...
                    <div class="container">
                        ...
                        <div class="row justify-content-center d-flex align-items-start">
                            <div class="col-sm">
                                ...
                                <input class="input-number mb-5" type="number" name="weight_after" min="35" max="200" step="0.01" style="width:110px;"> kg
                            </div>
                            <div class="col-sm">
                                <div class="text-center">
                        ...
                        <div class="modal-body" style="padding-bottom:0;">
                            <div class="container">
                                ...
                                @foreach($possessionItems as $possessionItem)
                                    ...
                                    @elseif($possessionItem->item_id == 5)
                                        <div class="row d-flex align-items-center" style="border-bottom: 2px solid #ffcb42;">
                                            <div class="col-6 text-left position-relative" style="top:5px; white-space:nowrap;">
                                                <label for="{{$possessionItem->item->name}}">{{$possessionItem->item->name}}</label>
                                            </div>
                                            <div class="col-4 position-relative" style="top:8px;">
                                            ...
                                            <div class="col-2">
                                                @if($possessionItem->possession_number <= 0)
                                                    <input type="radio" class="btn-check light position-relative" style="top:2px; transform:scale(1.8);" name="item[]" id="{{$possessionItem->item->name}}" value="{{$possessionItem->item->id}}" disabled>
                                                @else
