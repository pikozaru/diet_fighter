...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-5 text-center">
            <form method="POST" action="/heightEdits">
                {{ csrf_field() }}
                <input type="text" name="height" class="input-text" style="width:120px; font-size:20px;" autofocus placeholder="身長を入力" value="{{old('height', $user->height)}}">
