...
<head>
    ...
    <meta name="google-site-verification" content="aQfKwrUNCt9V29t82_hS1CuW_SYwMMpQzutBxU9Dcvk" />
    ...
    <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-8438832016475223"
...
<body>
    <div id="app">
        @component('components.quest_preparation_header')
        @endcomponent
        
        <div id="content-box">
            <main id="main" class="pt-5 pb-4" style="margin-top:120px;">
                @yield('quest_preparation_content')
            </main>
